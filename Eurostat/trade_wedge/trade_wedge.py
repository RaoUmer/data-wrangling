...
"""
For the trade wedge.
Data from Eurostat. Extraction date Nov 4/5 2012.
...
GDP
    ...
    http://appsso.eurostat.ec.europa.eu/nui/show.do?query=BOOKMARK_DS-055780_QID_32EF0224_UID_-
    3F171EB0&layout=TIME,C,X,0;GEO,L,Y,0;S_ADJ,L,Z,0;UNIT,L,Z,1;INDIC_NA,L,Z,2;INDICATORS,C,Z,3;
    &zSelection=DS-055780S_ADJ,NSA;DS-055780INDIC_NA,B1GM;DS-055780INDICATORS,OBS_FLAG;DS-055780
    UNIT,MIO_EUR_CLV2005;&rankName1=TIME_1_0_0_0&rankName2=INDIC-NA_1_2_-1_2&rankName3=S-ADJ_1_2_-
...
gdp_c = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/chained_gdp.csv',
...
gdp_n = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/nominal_gdp.csv', index_col=[1, 0],
    parse_dates=[1], date_parser=year_quarter, thousands=',',
    na_values=':').drop(['UNIT', 'INDIC_NA', 'S_ADJ'], axis=1)
gdp_n = gdp_n.unstack().stack(1)

imports_c = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/chained_imports.csv', index_col=[0, 1],
    parse_dates=[0], date_parser=year_quarter, thousands=',',
    na_values=':').drop(['UNIT', 'INDIC_NA', 'S_ADJ'], axis=1)
imports_c = imports_c.unstack().stack(1)

imports_n = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/nominal_imports.csv', index_col=[0, 1],
    parse_dates=[0], date_parser=year_quarter, thousands=',',
    na_values=':').drop(['UNIT', 'INDIC_NA', 'S_ADJ'], axis=1)
imports_n = imports_n.unstack().stack(1)

demand_c = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/chained_demand.csv', index_col=[0, 1],
    parse_dates=[0], date_parser=year_quarter, thousands=',',
    na_values=':').drop(['UNIT', 'INDIC_NA', 'S_ADJ'], axis=1)
demand_c = demand_c.unstack().stack(1)

demand_n = pd.read_csv('/Users/tom/TradeData/data-wrangling/Eurostat/trade_wedge/nominal_demand.csv', index_col=[0, 1],
    parse_dates=[0], date_parser=year_quarter, thousands=',',
    na_values=':').drop(['UNIT', 'INDIC_NA', 'S_ADJ'], axis=1)
